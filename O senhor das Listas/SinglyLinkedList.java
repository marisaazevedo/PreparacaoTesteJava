public class SinglyLinkedList<T> {
    ...
    // Conta e devolve o número de ocorrências de um valor
    ...
    // Devolve uma nova lista invertida
    public SinglyLinkedList<T> reverse() {
        Node<T> cur = first;
        SinglyLinkedList<T> reverse = new SinglyLinkedList<>();
    ...
    // Devolve um array com as posições de todas as ocorrências do elemento elem na lista
    ...
    // remove da lista todos os elementos que estão na lista toRemove
